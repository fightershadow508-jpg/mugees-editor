...
// Regex to safely match the exact block regardless of \r or spaces
const regex = /<div class="creator-photo-card">([\s\S]*?)<\/div>/;

const newHTML = `<div class="creator-photo-card" style="overflow:visible;">
...
appJs = appJs.replace(regex, newHTML);
fs.writeFileSync('app.js', appJs);
console.log('AppJS successfully updated');
